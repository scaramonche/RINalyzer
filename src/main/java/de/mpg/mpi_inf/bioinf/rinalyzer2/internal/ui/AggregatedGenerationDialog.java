...
public class AggregatedGenerationDialog extends JDialog implements ActionListener {
	 ...
	 */
	public AggregatedGenerationDialog(Frame aOwner, Set<String> aChainSet, String aNetTitle) {
		super(aOwner, Messages.DT_AGGREGATENET, true);
		owner = aOwner;
		chainSet = aChainSet;
	...
	private void init() {
		...
		panTitle.add(UtilsUI.createLabel(Messages.DI_NEWABSTRACTNET, null));
