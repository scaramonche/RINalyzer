...
public abstract class Messages {
	...
	//
	// public static String AC_RINLAYOUT = "RINLayout";
	//
	...
	// public static String DI_COMPARENETS =
	// "<html>Note that the network nodes are mapped according to the <br>"
	...
	public static String DI_NEWABSTRACTNET = "<html><b>You can select one or more of the protein chain(s)<br>"
			+ "contained in this RIN and create a new aggregated network<br>"
			+ "with nodes corresponding to secondary structure elements.</b></hmtl>";
	...
	// public static String LOG_WARNMODELCHANGE =
	// "The Chimera model has been changed and could not be linked to a Cytoscape network anymore.";
	//
	...
	//
	// public static String SM_CHIMERA_LOADPDB =
	// "Please load the pdb structure corresponding to the selected network!";
	//
	// public static String SM_CHIMERA_CLOSEMODELS =
	// "Please close all structures except for the one corresponding to the selected network!";
	...
	// public static String SM_DIFFNETSERROR =
	// "Please select different networks for the comparison!";

	public static String SM_ENTERNAME = "Please enter a name!";

	// public static String SM_ENTERNEWNAME =
	// "Please enter a network name that does not exist already!";
	...
	// public static String SM_NOBOOLATTR =
	// "There are no boolean attributes (selections) available.";

	// public static String SM_NONETWORK = "No network";

	// public static String SM_NONODES =
	// "<html>There were no nodes in the set that are contained in the<br>"
	...
	// public static String SM_NOSTRUCT =
	// "<html> <b>The PDB structure could not be opened!</b><br> "
	// + "Please check if this is a valid PDB file.<br></html>";

	// public static String SM_NOSUCCESS =
	// "<html>Successfully loaded the selected PDB structure in Chimera, <br> "
	...
	// public static String SM_NOTALLNODES1 =
	// "<html> Some of the nodes in the set are not contained in the network<br>";
	//
	// public static String SM_NOTALLNODES2 = " and therefore cannot be added.<html>";

	// public static String SM_ONLYNODESNET =
	// "<html>Some of the nodes in the set are not contained in the<br>"
	// + "current network and cannot be added to the new network.</html>";
	//
	// public static String SM_ONLYNODESANAL =
	// "<html>Some of the nodes in the set are not contained in the<br>"
	// + "current network. The analyzed set will contain only the<br>"
	// + "nodes that are both in the set and in the network.</html>";
	//
	// public static String SM_OPENSTRUCT =
	// " is already opened. You are not allowed to open the same model twice.";
	...
	//
	// public static String SM_LOADSAMENETWORK =
	// "Please load the network to which the nodes in the selected set belong!";
	//
	// public static String SM_SAMENETWORKS =
	// "Please select two sets containing nodes from the same network!";
	//
	// public static String SM_SELECTNETWORK =
	// "Please select a network from the list of loaded networks.";

	// public static String SM_SELECTNODES =
	// "<html>Please select at least 2 nodes for analysis!<br><br>"
	...
	//
	// public static String SM_SELECTSINGLENET =
	// "Please select a single network from the list of loaded networks.";
	//
	...
	//
	// public static String SM_SUCCESS =
	// "<html>Successfully loaded the selected PDB structure in Chimera <br> "
	...
	public static final String[] defaultStructureKeys = { "pdbFileName", "Structure", "pdb",
			"PDB ID", "structure", "biopax.xref.PDB", "pdb_ids", "ModelName", "ModelNumber" };
	...
	/**
	 * Name of the properties file stored in the user's cytoscape directory.
	 */
	...
	static {
		...
		blosum62 = new double[][] {
				...
				{ -2, 0, 1, -1, -3, 0, 0, -2, 8, -3, -3, -1, -2, -1, -2, -1, -2, -2, 2, -3, 0, 0,
						-1, -4 },
				{ -1, -3, -3, -3, -1, -3, -3, -4, -3, 4, 2, -3, 1, 0, -3, -2, -1, -3, -1, 3, -3,
						-3, -1, -4 },
				...
				{ -3, -3, -4, -4, -2, -2, -3, -2, -2, -3, -2, -3, -1, 1, -4, -3, -2, 11, 2, -3, -4,
						-3, -2, -4 },
				{ -2, -2, -2, -3, -2, -1, -2, -3, 2, -1, -1, -2, -1, 3, -3, -2, -2, 2, 7, -1, -3,
						-2, -1, -4 },
				{ 0, -3, -3, -3, -1, -2, -2, -3, -3, 3, 1, -2, 1, -1, -2, -2, 0, -3, -1, 4, -3, -2,
						-1, -4 },
				{ -2, -1, 3, 4, -3, 0, 1, -1, 0, -3, -4, 0, -3, -3, -2, 0, -1, -4, -3, -3, 4, 1,
						-1, -4 },
		...
		blosum62AA = Arrays.asList(new String[] { "A", "R", "N", "D", "C", "Q", "E", "G", "H", "I",
